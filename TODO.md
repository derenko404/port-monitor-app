...
- [ ] **Force-kill fallback** — if SIGTERM ignored and process still listening, offer SIGKILL ("still running… force?")
...
- [ ] **Tray badge / count** — show # listening ports next to tray icon (`tray.setTitle`)
...
- [ ] Kill signal choice (SIGTERM / SIGKILL default)
